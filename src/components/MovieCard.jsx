...
import { Heart, XCircle, Star, TrendingUp, Calendar, Clock } from "lucide-react";
...
function MovieCard({ movieObj, poster_path, name }) {
  ...
  return (
    ...
    >
      ...
      <div 
        className={`absolute inset-0 bg-cover bg-center filter blur-sm transition-opacity duration-500 ${imageLoaded ? 'opacity-0' : 'opacity-100'}`}
        style={{
      ...
      >
        ...
        <div className="flex items-center mb-2">
          ...
          <span className="font-semibold">{movieObj.vote_average?.toFixed(1)}</span>
